import unittest
from tests import RequiresWorkers, RequiresDB
from digester import Digester
from digester.wikidigester import WikiDigester, WikiDigesterDistributed
import time
...
class WikiDigesterDistributedTest(RequiresWorkers):
    # Requires that RabbitMQ and a Celery worker are running.

    def setUp(self):
        # Create the WikiDigesterDistributed and purge its db.
        self.w = WikiDigesterDistributed('tests/data/article.xml', silent=True, db='test')
        self.w.purge()
    ...
    def test_instance(self):
        self.assertIsInstance(self.w, WikiDigesterDistributed)
